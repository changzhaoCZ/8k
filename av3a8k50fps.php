...
if (!$playUrl) {
    ...
    $postData = 'appcommon={"ap":"cctv_app_tv","an":"央视投屏助手","adid":"1234123122","av":"1.1.7"}&url=http://liveali-tp4k.cctv.cn/live/4K36M/playlist.m3u8';
    $ch = curl_init();
...
$data = curl_exec($ch);
curl_close($ch);
$data = preg_replace('/(.*?.ts)/i', "http://liveali-tp4k.cctv.cn/live/4K36M/$1", $data);
